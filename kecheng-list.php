...
<?php
    foreach($array as $key=>$values){
        ...
        echo "<td><a class='sui-btn btn-small btn-warning' href='kecheng-update.php?sid={$values['课程编号']}'>修改</a>&nbsp;&nbsp;
<a class='sui-btn btn-small btn-danger' href='kecheng-del.php?sid={$values['课程编号']}'>删除</a></td>";
        echo "</tr>";
    }
?>
			</table>
