			...
			<div class="content">
				...
				<form class="sui-form form-horizontal sui-validate" action="news-save.php" method="post" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="authors" name="authors" class="input-large input-fat"  placeholder="输入肩题" data-rules="required|minlength=1|maxlength=10" value="<?php echo $_SESSION['usname']?>" readonly>
						</div>
					</div>
					<div class="control-group">
						<label for="Issue" class="control-label">发布时间：</label>
						<div class="controls">
							<input type="text" id="Issue" name="Issue" class="input-fat input-large" placeholder="输入时间" data-toggle="datepicker">
						</div>
					</div>
					<div class="control-group">
