			...
			<tr>
				...
				<?php
					foreach($array as $key=>$values){
						...
						echo "<td><a class='sui-btn btn-small btn-warning' href='banji-update.php?sid={$values['班号']}'>修改</a>&nbsp;&nbsp;
						<a class='sui-btn btn-small btn-danger' href='banji-del.php?sid={$values['班号']}'>删除</a></td>";
						echo "</tr>";
					}
				?>
		</table>
